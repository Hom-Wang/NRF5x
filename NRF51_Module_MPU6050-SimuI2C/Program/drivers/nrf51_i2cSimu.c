...
#define I2CxS_SCL_L()         __GPIO_RST(I2CxS_SCL_PIN)
#define I2CxS_SCL_H()         __GPIO_SET(I2CxS_SCL_PIN)

#define I2CxS_SDA_PIN         SimuI2C_Init->PinSDA
#define I2CxS_SDA_L()         __GPIO_RST(I2CxS_SDA_PIN)
#define I2CxS_SDA_H()         __GPIO_SET(I2CxS_SDA_PIN)
#define I2CxS_SDA_READ()      (__GPIO_READ(I2CxS_SDA_PIN) == 1)
/*====================================================================================================*/
/*====================================================================================================*/
...
{
  nrf_gpio_cfg_output(SimuI2C_Init->PinSCL);
  nrf_gpio_cfg_output(SimuI2C_Init->PinSDA);
}
/*====================================================================================================*/
/*====================================================================================================*
**函數 : SimuI2C_Delay
