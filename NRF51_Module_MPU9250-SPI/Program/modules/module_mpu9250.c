...
#define SPIx_SPEED_HIGH   SPI_FREQUENCY_FREQUENCY_M8
#define SPIx_SPEED_LOW    SPI_FREQUENCY_FREQUENCY_M8

#define SPIx_CS_PIN       12
#define SPIx_CS_H()       __GPIO_SET(SPIx_CS_PIN)
#define SPIx_CS_L()       __GPIO_RST(SPIx_CS_PIN)
#define SPIx_SCK_PIN      13
#define SPIx_SDO_PIN      14
#define SPIx_SDI_PIN      15

#define _USE_MAG_AK8963
#define MAG_READ_DELAY 256
/*====================================================================================================*/
/*====================================================================================================*/
static SPI_InitTypeDef MPU92_InitTypeDef;
...
**====================================================================================================*/
/*====================================================================================================*/
void MPU9250_SetSpeed( uint32_t speedSel )
{
  SPI_Cmd(SPIx, DISABLE);
  MPU92_InitTypeDef.Freguency = speedSel;
  SPI_Init(SPIx, &MPU92_InitTypeDef);
...
void MPU9250_Config( void )
{
  ...
  MPU92_InitTypeDef.PinCS     = SPIx_CS_PIN;
  MPU92_InitTypeDef.PinSCK    = SPIx_SCK_PIN;
  MPU92_InitTypeDef.PinMOSI   = SPIx_SDI_PIN;
  MPU92_InitTypeDef.PinMISO   = SPIx_SDO_PIN;
  MPU92_InitTypeDef.CPOL      = SPI_CONFIG_CPOL_ActiveHigh;  // SPI_CONFIG_CPOL_ActiveLow, SPI_CONFIG_CPOL_ActiveHigh
  MPU92_InitTypeDef.CPHA      = SPI_CONFIG_CPHA_Leading;     // SPI_CONFIG_CPHA_Trailing, SPI_CONFIG_CPHA_Leading
  MPU92_InitTypeDef.BitOrder  = SPI_CONFIG_ORDER_MsbFirst;
  MPU92_InitTypeDef.Freguency = SPIx_SPEED_LOW;
  SPI_Init(SPIx, &MPU92_InitTypeDef);
